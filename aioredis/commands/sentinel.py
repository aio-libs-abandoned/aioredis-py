...
from aioredis.typing import CommandsProtocol, EncodableT, PatternT


class SentinelCommands(CommandsProtocol):
    """
    ...
    def sentinel_reset(self, pattern: PatternT) -> Awaitable:
        """
    ...
    def sentinel_failover(self, new_master_name: str) -> Awaitable:
        """
    ...
    def sentinel_ckquorum(self, new_master_name: str) -> Awaitable:
        """
    ...
    def sentinel_flushconfig(self) -> Awaitable:
        """
