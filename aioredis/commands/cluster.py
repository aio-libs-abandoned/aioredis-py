from aioredis.crc import key_slot
from aioredis.exceptions import ConnectionError, DataError, RedisError
from aioredis.typing import CommandsProtocol

from .core import DataAccessCommands
from .helpers import list_or_args


class ClusterMultiKeyCommands(CommandsProtocol):
    """
    ...
    def mget_nonatomic(self, keys, *args):
        ...
        from aioredis.client import EMPTY_RESPONSE
...
class ClusterManagementCommands(CommandsProtocol):
    """
...
class ClusterPubSubCommands(CommandsProtocol):
    """
