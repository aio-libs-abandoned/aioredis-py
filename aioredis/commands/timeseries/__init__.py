...
class TimeSeries(TimeSeriesCommands):
    ...
    def __init__(self, client=None, **kwargs):
        ...
        self.MODULE_CALLBACKS = {
            CREATE_CMD: aioredis.client.bool_ok,
            ALTER_CMD: aioredis.client.bool_ok,
            CREATERULE_CMD: aioredis.client.bool_ok,
            DEL_CMD: int,
            DELETERULE_CMD: aioredis.client.bool_ok,
...
class Pipeline(TimeSeriesCommands, aioredis.client.Pipeline):
