...
@redis_version(2, 8, 0, reason="PUBSUB CHANNELS is available since redis>=2.8.0")
@pytest.mark.asyncio
...
@redis_version(2, 8, 0, reason="PUBSUB NUMSUB is available since redis>=2.8.0")
@pytest.mark.asyncio
...
@redis_version(2, 8, 0, reason="PUBSUB NUMPAT is available since redis>=2.8.0")
@pytest.mark.asyncio
...
@redis_version(3, 2, 0, reason="PUBSUB PING is available since redis>=3.2.0")
@pytest.mark.asyncio
...
@redis_version(2, 8, 12, reason="extended `client kill` format required")
@pytest.mark.asyncio
